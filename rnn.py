...
from layernorm_lstm import LayerNormLSTM, LSTM
import math
...
class RNN(nn.Module):
    def __init__(self, hidden_size=16, num_lstm_layers=1) -> None:
        ...
        #self.lstm = nn.LSTM(input_size=hidden_size, hidden_size=hidden_size, num_lstm_layers=1, batch_first=True)
    ...
    def forward(self, x):
        ...
        h_n, c_n = torch.empty(self.hidden_size, self.batch_size, ).normal_(0, math.sqrt(self.hidden_size)), torch.zeros(self.hidden_size, self.batch_size)
